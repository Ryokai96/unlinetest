...
import com.ryoukai.unlinetest.dto.TestPaper;
 ...
 *
 */
public class TestOperate implements Comparator<Question>{
	 ...
	 */
	public static void readTest(String filePath, TestPaper testPaper) {
	 ...
	 * @param testPaper TestPaper实体类
	 */
	public static void readSolution(String filePath, TestPaper testPaper) {
		SAXReader reader = TestOperate.getReader();
		File f = new File(filePath);
		try {
			Document doc = reader.read(f);
